...
public abstract class Md5 {
    ...
    public static <T extends Md5> void register(Class<T> clazz) {
    ...
    public static Md5 getInstance() {
        return TypeRegistry.getInstance(Md5.class);
    }

    public static <T extends Md5> Md5 getInstance(Class<T> clazz) {
    ...
    public String generateInBase64(
        ...
        try {
            ...
            Logger.getInstance(Md5.class.getSimpleName()).error(e.toString());
        }
        return result;
    }
